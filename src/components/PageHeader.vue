...
const button = ref();
const useElementBoundingReturn = useElementBounding(button);
const { top, right, height } = useElementBoundingReturn;
...
onMounted(() => {
  popupStore.registerInitHook('header', () => useElementBoundingReturn.update()) // 打开弹窗时更新元素位置
})
</script>

<template>
  <div class="mx-auto grid max-w-6xl grid-cols-2 items-center gap-4 px-4 py-4 md:px-8">
