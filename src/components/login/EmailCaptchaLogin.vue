  ...
  <form v-if="currentStep === 'EMAIL_INPUT'" class="flex flex-col gap-5" @submit.prevent="handleEmailSubmit">
    ...
    <div class="flex flex-col gap-2">
      ...
      <div class="flex items-center gap-3">
        ...
        <button type="button" @click="refreshImageCaptcha()" title="点击刷新验证码" class="group relative shrink-0 overflow-hidden rounded-md border border-(--border) transition-opacity hover:opacity-90">
